...
{
    public sealed partial class EditorResourceComponent : MonoBehaviour, IResourceManager
    {
...
#pragma warning restore 0067, 0414
        ...
        /// 检查版本列表
        /// </summary>
        /// <param name="lastesInternalResourceVersion">最新的资源内部版本号</param>
        /// <returns></returns>
        public CheckVersionListResult CheckVersionList(int lastesInternalResourceVersion)
        {
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            ...
            {
                loadAssetCallbacks.LoadAssetFailureCallback(assetName, LoadResourceStatus.NotExist, "Can not load this asset from asset datebase.", userData);
            }
#endif
        }
