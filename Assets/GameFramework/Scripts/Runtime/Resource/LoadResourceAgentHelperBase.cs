...
namespace UnityGameFramework.Runtime
{
    ...
    public abstract class LoadResourceAgentHelperBase : MonoBehaviour, ILoadResourceAgentHelper
    {
        ...
        /// <summary>
        /// 加载资源代理辅助器异步将资源二进制文件转换为加载对象完成事件
        /// </summary>
        ...
        /// </summary>
        /// <param name="fullPath">要加载资源的完整文件名</param>
        public abstract void ReadFile(string fullPath);

        /// <summary>
        /// 通过加载资源代理辅助器开始异步读取资源二进制文件
        /// </summary>
        /// <param name="fullPath">要加载资源的完整文件名</param>
        /// <param name="loadPath">资源加载方式</param>
        public abstract void ReadBytes(string fullPath, int loadPath);

        /// <summary>
        /// 通过加载资源代理辅助器开始异步将资源二进制文件转化为加载对象
        /// </summary>
        ...
        /// <param name="inScene">要加载的资源是否是场景</param>
        public abstract void LoadAsset(object resource, string resourceChildName, bool inScene);
