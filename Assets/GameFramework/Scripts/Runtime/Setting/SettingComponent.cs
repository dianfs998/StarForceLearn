...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class SettingComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_SettingHelperTypeName = "UnityGameFramwork.Runtime.DefaultSettingHelper";
        ...
        /// <returns>读取的对象</returns>
        public T GetObject<T>(string key, T defaultObject)
        {
            return m_SettingManager.GetObject<T>(key, defaultObject);
        }
        ...
        /// <param name="defaultObject">当指定的配置项不存在时，返回此默认对象</param>
        /// <returns>读取的对象</returns>
        public object GetObject(Type objectType, string key, object defaultObject)
        {
            return m_SettingManager.GetObject(objectType, key, defaultObject);
        }
        ...
        {
            m_SettingManager.SetObject<T>(key, obj);
        }
