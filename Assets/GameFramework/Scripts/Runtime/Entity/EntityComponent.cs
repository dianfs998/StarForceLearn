...
namespace UnityGameFramework.Runtime
{
    ...
    public partial class EntityComponent : GameFrameworkComponent
    {
        ...
        /// 附加子实体
        /// </summary>
        /// <param name="childEntityId">要附加的子实体编号</param>
        /// <param name="parentEntityId">被附加的父实体编号</param>
        ...
        /// 附加子实体
        /// </summary>
        /// <param name="childEntityId">要附加的子实体</param>
        /// <param name="parentEntityId">被附加的父实体</param>
        /// <param name="userData">用户自定义数据</param>
        ...
        /// 附加子实体
        /// </summary>
        /// <param name="childEntiytyId">要附加的子实体编号</param>
        /// <param name="parentEntity">被附加的父实体</param>
        /// <param name="userData">用户自定义数据</param>
        ...
        /// </summary>
        /// <param name="childEntityId">要附加的子实体编号</param>
        /// <param name="parentEntity">被附加的父实体编号</param>
        /// <param name="parentTransform">相对于被附加父实体的位置</param>
        /// <param name="userData">用户自定义数据</param>
        ...
        /// 解除所有子实体
        /// </summary>
        /// <param name="parentEntity">被解除的父实体的实体</param>
