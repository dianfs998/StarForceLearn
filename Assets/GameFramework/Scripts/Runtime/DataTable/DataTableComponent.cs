...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class DataTableComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private bool m_EnableLoadDataTableDependencyAssetEvent = true;
        ...
        {
            LoadDataTable(typeof(T), null, dataTableName, dataTableAssetName, null);
        }
        ...
        {
            LoadDataTable(dataRowType, null, dataTableName, dataTableAssetName, null);
        }
        ...
        /// <param name="name">数据表名称</param>
        /// <returns>销毁数据表是否成功</returns>
        public bool DestroyDataTabale(Type dataRowType, string name)
        {
