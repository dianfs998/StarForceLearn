    ...
    public partial class DebuggerComponent
    {
        ...
        private sealed partial class ConsoleWindow : IDebuggerWindow
        {
            ...
            public string DateTimeFormat
            {
                ...
                set { m_DateTimeFormat = value ?? string.Empty; }
            }
            ...
            public void OnDraw()
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    m_InfoFilter = GUILayout.Toggle(m_InfoFilter, string.Format("Info ({0})", m_InfoFilter.ToString()), GUILayout.Width(90f));
                    m_WarningFilter = GUILayout.Toggle(m_WarningFilter, string.Format("Warning ({0})", m_WarningFilter.ToString()), GUILayout.Width(90f));
                    m_ErrorFilter = GUILayout.Toggle(m_ErrorFilter, string.Format("Error ({0})", m_ErrorFilter.ToString()), GUILayout.Width(90f));
                    m_FatalFilter = GUILayout.Toggle(m_FatalFilter, string.Format("Fatal {0}", m_FatalFilter.ToString()), GUILayout.Width(90f));
                }
                    ...
                    m_StackScrollPosition = GUILayout.BeginScrollView(m_StackScrollPosition, GUILayout.Height(100f));
                    {
                        if(m_SelectedNode != null)
                        {
                            ...
                            GUILayout.Label(string.Format("<color=#{0}{1}{2}{3}><b>{4}</b></color>",
                                ...
                                m_SelectedNode.Value.LogMessage));
