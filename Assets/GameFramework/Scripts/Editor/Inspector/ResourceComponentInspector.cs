    ...
    internal sealed class ResourceComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(EditorApplication.isPlaying && PrefabUtility.GetPrefabType(t.gameObject) != PrefabType.Prefab)
            {
                ...
                EditorGUILayout.LabelField("Current Variant", t.CurrentVariant ?? "<Unknown>");
                EditorGUILayout.LabelField("Applicable Game Version", isEditorResourceMode ? "N/A" : t.ApplicableGameVersion ?? "<Unknown>");
                ...
                EditorGUILayout.LabelField("Load Waiting Agent Count", isEditorResourceMode ? "N/A" : t.LoadWaitingTaskCount.ToString());
            }
