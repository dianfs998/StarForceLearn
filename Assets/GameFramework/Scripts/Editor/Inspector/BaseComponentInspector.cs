    ...
    internal sealed class BaseComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                {
                    EditorGUILayout.HelpBox("Editor resource mode option is only for editor mode. Game Framework will use ediotr resource files, which you should validate first.", MessageType.Warning);
        ...
        private void RefreshTypeNames()
        {
            ...
            List<string> profilerHelperTypeNames = new List<string> { NoneOptionName };
