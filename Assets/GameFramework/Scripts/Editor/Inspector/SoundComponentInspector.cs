...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class SoundComponentInspector : GameFrameworkInspector
    {
        ...
        private HelperInfo<SoundGroupHelperBase> m_SoundGroupHelperInfo = new HelperInfo<SoundGroupHelperBase>("Sound Group");
        private HelperInfo<SoundAgentHelperBase> m_SoundAgentHelperInfo = new HelperInfo<SoundAgentHelperBase>("Sound Agent");
        ...
        private void OnEnable()
        {
            ...
            m_EnablePlaySoundDependencyAssetEvent = serializedObject.FindProperty("m_EnablePlaySoundDependencyAssetEvnet");
